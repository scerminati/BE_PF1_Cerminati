...
Este proyecto es la programación del Backend del E-Commerce So-Games, para juegos de mesa, junto con la implementación de su FrontEnd.
...
- **`app.js`**: Archivo principal que arranca el servidor y configura la aplicación.
